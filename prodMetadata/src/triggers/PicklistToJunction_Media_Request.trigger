...
trigger PicklistToJunction_Media_Request on Media_Request__c (after insert, after update, after undelete) {


	// ***** CUSTOMIZE THESE VALUES WHEN YOU COPY THE TRIGGER TO OTHER OBJECTS *****
	
	public static String pickField = 'Related_to_program__c'; // name of multi-select field on this object
	public static String targetObject = 'Focus_Area__c'; // target object name
	public static String junctionObject = 'Focus_Area_Media_Request_junction__c'; // junction object name
	public static String junctHomeLookup = 'Media_Request__c'; // lookup field on the junction object to this object
	public static String junctTargetLookup = 'Focus_Area__c'; // lookup field on the junction object to target object
